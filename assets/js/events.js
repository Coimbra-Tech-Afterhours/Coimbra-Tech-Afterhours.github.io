    ...
    return `
      <div class="event-row ${statusClass} ${typeClass}">
        ...
        <div class="event-row__meta">
          ...
          ${languagesHTML ? `<span class="meta">${languagesHTML}</span>` : ''}
        </div>
  ...
  async function renderEventsPage() {
    ...
    if (organizerCTAContainer) {
      ...
      organizerCTAContainer.innerHTML = `
        ...
        <a href="/#contact" class="button button-secondary" data-i18n-pt="${t.organizerCTAButton}" data-i18n-en="${i18n.en.organizerCTAButton}">${t.organizerCTAButton}</a>
      `;
    }
